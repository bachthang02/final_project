			...
			<div class="col-md-7 col-sm-7">
				...
				<form action="${pageContext.request.contextPath }/login"
					...
					<div class="form-group">
						<label for="slug" class="col-lg-4 control-label">Slug
					...
					<div class="form-group">
						<label for="hashed_password" class="col-lg-4 control-label">Password
							<span class="require"></span>
						</label>
						<div class="col-lg-8">
							<input type="text" class="form-control" id="hashed_password"
								name="hashed_password" required> 
